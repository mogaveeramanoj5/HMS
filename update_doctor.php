...
if(isset($_POST['update'])) {
    ...
    $spl = $_POST['spl'];
    $exp = $_POST['exp'];
    $qryy="select * from doctor where doctor_id='$docid'";
    $result=mysqli_query($conn,$qryy);
    if (mysqli_num_rows($result) > 0)
    {
        $qry="UPDATE doctor SET email='$email', phone='$phone', age='$age', specialization='$spl', experience='$exp' where doctor_id='$docid'";
        $res=mysqli_query($conn,$qry);
        echo "<script>alert('doctor details updated'); window.location='admin_dashboard.php';</script>";
    }
    else{
         echo "<script>alert('Doctor not found'); window.location='admin_dashboard.php';</script>";
    }
}
?>
<html>
...
<body class="page-body">
    <div class="registration-card">
        <div class="card-header">
            <h2 class="header-title">Update Doctor</h2>
        </div>
